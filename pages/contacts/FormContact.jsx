   ...
   return (
      <div className="w-full">
         ...
         <form
            ...
            className="space-y-4 bg-white/80 backdrop-blur-sm p-6 rounded-lg shadow-md"
         >
            <input
               type="text"
               placeholder="Nom*"
            ...
            <button
               type="submit"
               className="w-full sm:w-auto bg-blue-900 text-white px-6 py-2 rounded hover:text-yellow-400 hover:bg-blue-800 transition"
            >
               Envoyer
            </button>
         </form>
